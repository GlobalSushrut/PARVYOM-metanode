...
impl Default for BpiEndpoints {
    fn default() -> Self {
        Self {
            api_endpoint: "http://0.0.0.0:8081".to_string(),
            rpc_endpoint: "http://0.0.0.0:8546".to_string(),
            mesh_endpoint: "http://0.0.0.0:9000".to_string(),
            registry_endpoint: "http://0.0.0.0:7000".to_string(),
        }
    }
}
    ...
    async fn register_node(&self) -> Result<()> {
        ...
        let mining_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                ...
                websocket: Some("0.0.0.0:9001".to_string()),
                p2p: Some("0.0.0.0:9000".to_string()),
            },
            stake: None,
        ...
        let bpci_server1_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                ...
                websocket: Some("0.0.0.0:9002".to_string()),
                p2p: Some("0.0.0.0:9000".to_string()),
            },
            stake: None,
            reputation: crate::registry::ReputationScore::new(),
        ...
        let bpci_server2_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                ...
                websocket: Some("0.0.0.0:9003".to_string()),
                p2p: Some("0.0.0.0:9000".to_string()),
            },
            stake: None,
            reputation: crate::registry::ReputationScore::new(),
        ...
        let validator_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                ...
                websocket: Some("0.0.0.0:9004".to_string()),
                p2p: Some("0.0.0.0:9000".to_string()),
            },
            stake: Some(1000),
            reputation: crate::registry::ReputationScore::new(),
        ...
        let notary_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                ...
                websocket: Some("0.0.0.0:9005".to_string()),
                p2p: Some("0.0.0.0:9000".to_string()),
            },
            stake: None,
            reputation: crate::registry::ReputationScore::new(),
        ...
        let logbook_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                ...
                websocket: Some("0.0.0.0:9006".to_string()),
                p2p: Some("0.0.0.0:9000".to_string()),
            },
        ...
        let roundtable_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                ...
                websocket: Some("0.0.0.0:9007".to_string()),
                p2p: Some("0.0.0.0:9000".to_string()),
            },
        ...
        let boxblock_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                ...
                websocket: Some("0.0.0.0:9008".to_string()),
                p2p: Some("0.0.0.0:9000".to_string()),
            },
        ...
        let roundtable_api_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                primary: "0.0.0.0:8560".to_string(),
                backup: vec!["0.0.0.0:8561".to_string()],
                api: Some("0.0.0.0:8560".to_string()),
                websocket: Some("0.0.0.0:8560".to_string()),
                p2p: Some("0.0.0.0:8562".to_string()),
            },
        ...
        let bank_api_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                primary: "0.0.0.0:8570".to_string(),
                backup: vec!["0.0.0.0:8571".to_string()],
                api: Some("0.0.0.0:8570".to_string()),
                websocket: Some("0.0.0.0:8570".to_string()),
                p2p: Some("0.0.0.0:8572".to_string()),
            },
        ...
        let govt_api_registration = crate::registry::NodeRegistration {
            ...
            endpoints: crate::registry::NetworkEndpoints {
                primary: "0.0.0.0:8580".to_string(),
                backup: vec!["0.0.0.0:8581".to_string()],
                api: Some("0.0.0.0:8580".to_string()),
                websocket: Some("0.0.0.0:8580".to_string()),
                p2p: Some("0.0.0.0:8582".to_string()),
            },
