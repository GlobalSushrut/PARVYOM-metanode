  ...
  const enterpriseFeatures = [
    {
      ...
      title: "Experimental Security (Needs Audits)",
      description: "Post-quantum cryptography concepts implemented. Needs external security audits and validation before production use."
    },
    {
      icon: <BankOutlined className="text-3xl text-green-600" />,
      title: "Banking API Concepts (Not Compliant)",
      description: "Banking API architecture designed but not certified. Needs compliance audits (Basel III, PCI DSS, SOX) before banking use."
    },
    {
      icon: <GlobalOutlined className="text-3xl text-purple-600" />,
      title: "Government Architecture (Not Certified)",
      description: "Government-grade architecture concepts. Needs FedRAMP, FISMA, NIST certification before government deployment."
    },
    {
      icon: <ApiOutlined className="text-3xl text-orange-600" />,
      title: "Operational APIs (Testing Needed)",
      description: "15 backend services with real APIs deployed. Needs testing, performance optimization, and pilot validation."
    }
  ];

  const useCases = [
    {
      sector: "Banking & Finance (Pilot Testing Only)",
      icon: <BankOutlined className="text-2xl text-blue-600" />,
      applications: [
        "Experimental payment infrastructure (testnet)",
        "CBDC research concepts (not production)",
        "Trade finance architecture (needs validation)",
        "Audit trail systems (operational, needs testing)",
        "Compliance monitoring (concepts only)"
      ],
      benefits: "Research platform for exploring blockchain banking concepts. Needs 6-12 months pilot testing before production."
    },
    {
      sector: "Government & Defense (Research Phase)",
      icon: <SafetyOutlined className="text-2xl text-green-600" />,
      applications: [
        "Experimental secure communications (testnet)",
        "Digital identity concepts (not certified)",
        "Healthcare data architecture (needs HIPAA audit)",
        "Supply chain research (pilot testing needed)",
        "Emergency response concepts (not operational)"
      ],
      benefits: "Research platform for government blockchain concepts. Needs certification and 1-2 years development before deployment."
    },
    {
      sector: "Enterprise & Corporate (Pilot Program)",
      icon: <CloudServerOutlined className="text-2xl text-purple-600" />,
      applications: [
        "Supply chain research (experimental)",
        "Document verification concepts (testing needed)",
        "Settlement architecture (not production-ready)",
        "Audit trail systems (operational, needs validation)",
        "IP protection concepts (research phase)"
      ],
      benefits: "Pilot testing platform for enterprise blockchain concepts. 75% infrastructure ready, needs 6-12 months testing."
    }
  ];
